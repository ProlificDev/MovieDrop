    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center w-full px-4 sm:px-6 pt-4 sm:pt-6 pointer-events-none">
        ...
        >
          <div className="w-full h-full px-4 sm:px-6 flex items-center justify-between">
            ...
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 flex-shrink-0 group" aria-label="MoviePulse Home">
              <img
                src="/logo.png"
                alt="MoviePulse Logo"
      ...
      >
        ...
        <div
          ...
          style={{ height: `${NAV_HEIGHT}px`, borderBottom: '1px solid rgba(255,255,255,0.07)', flexShrink: 0 }}
        >
          <span
          ...
          <button
            ...
            onClick={() => setIsMenuOpen(false)}
            className="flex items-center justify-center w-9 h-9 rounded-xl text-white cursor-pointer"
